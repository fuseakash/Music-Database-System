...
<div class="search-container">
    <form action="searchsinger.py">
      <input type="text" placeholder="Enter the Singer name." name="sname">
	...
	<main>
		...
		<section class = "right">
	<table>
				<tr><th>Singer Name</th>

				<tr>
					<td>Rekha Bhardwaj</td>
