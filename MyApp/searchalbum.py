...
mycursor.execute("select song_title from song where album_name='" + name+"'")
...
.zoom {
  padding: 50px;
  background-image: url('img/album1.jpeg');
  text-align: center;
...
<form action="albums.py"><button type="submit"><strong>Back</strong></button>
