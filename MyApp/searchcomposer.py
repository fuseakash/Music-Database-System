...
mycursor.execute("select composer_id from composer where composer_name='" + name+"'")
result1 = mycursor.fetchall()
result1=result1[0][0]

mycursor.execute("select album_name from album where composer_id=" + str(result1))
...
.zoom {
  padding: 50px;
  background-image: url('img/composer.jpeg');
  text-align: center;
...
print('''
  ...
  <form action="composer.py"><button type="submit"><strong>Back</strong></button>
